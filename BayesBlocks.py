...
def testBayes():
    ...
    filename = '/Users/mikkosavola/Documents/Opiskelu_HY/EVT_flux_project/python/bayesBlocks-master/testData/tteascii.00551'
    ...
    H1 = plt.hist(subDF.TIME, bins=32, histtype='stepfilled', alpha=0.2, density=True)
    H2 = plt.hist(subDF.TIME, bins=subDF.TIME[myBlocks.change_points], color='k', histtype='step', density=True)
    plt.show()
