...
def plot_GPD_fit(fe130,fe130_orig,a_fe130,q,decl):
    q=q
...
# q=0.90
# while q<0.99:
#     plot_GPD_fit(fe130,fe130_orig,a_fe130q,decl)
#     q=q+0.1
# q=0.98
# while q<0.999:
#     plot_GPD_fit(fe130,fe130_orig,a_fe130,q,decl)
#     q=q+0.01
q=0.998
while q<0.9999:
    plot_GPD_fit(fe130,fe130_orig,a_fe130,q,decl)
